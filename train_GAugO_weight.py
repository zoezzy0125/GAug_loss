...
if __name__ == "__main__":
    ...
    features = pickle.load(open(f'data/graphs/{args.dataset}_features.pkl', 'rb')).cpu()
    labels = pickle.load(open(f'data/graphs/{args.dataset}_labels.pkl', 'rb')).cpu()
    if sp.issparse(features):
        features = torch.FloatTensor(features.toarray())
    edge_weights = pickle.load(open(f'{args.dataset}_deg_weight.pkl', 'rb'))
